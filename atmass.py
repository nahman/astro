...
def m_atm_dot_dusty(a,m_core,m_core_dot,m_atm,t):
    ...
    if m_atm/m_core>=.5: 
        return (GCR_dusty_dot(a,m_core,m_core_dot,t)*m_core+GCR_dusty(a,m_core,t)*m_core_dot)*np.exp(-ct.atm_smooth*(m_atm/m_core-.5)) #this is a place holder. 
        #note that the exponential is being used as a smoothing factor to keep my derivatives continuous
