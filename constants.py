...
Pcol_fudge=1 #divisor to Pcol. Setting to 3 matches this Pcol with Eve's (approximately)


core_smooth=10000 #These params control how quickly the time derivatives of core mass and atm mass decay to 0 after the core/atm stops growing.
atm_smooth=10000  #The decay is exponential in form, and mainly was implemented to keep the derivatives continous.
...
Run parameters
'''
reg='hyp' #manually set the regime we are in when we calculate Pcol
