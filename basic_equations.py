...
def power_factor(t):  #power scaling for sigma
    return (t/10**ct.t_init)**(-5/4)

def Sigma_gas_power(t):
    return Sigma_gas(a)*power_factor(t)

def power_factor_dot(t):
    return -5/4*1/(10**ct.t_init)*(t/10**ct.t_init)**(-9/4)

def Sigma_gas_power_dot(a,t):
